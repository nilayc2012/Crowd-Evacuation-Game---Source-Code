...
{
	Color_t2020392075_marshaled_pinvoke ___m_NormalColor_0;
	Color_t2020392075_marshaled_pinvoke ___m_HighlightedColor_1;
	Color_t2020392075_marshaled_pinvoke ___m_PressedColor_2;
	Color_t2020392075_marshaled_pinvoke ___m_DisabledColor_3;
	float ___m_ColorMultiplier_4;
	float ___m_FadeDuration_5;
};
// Native definition for marshalling of: UnityEngine.UI.ColorBlock
...
{
	Color_t2020392075_marshaled_com ___m_NormalColor_0;
	Color_t2020392075_marshaled_com ___m_HighlightedColor_1;
	Color_t2020392075_marshaled_com ___m_PressedColor_2;
	Color_t2020392075_marshaled_com ___m_DisabledColor_3;
	float ___m_ColorMultiplier_4;
	float ___m_FadeDuration_5;
};
