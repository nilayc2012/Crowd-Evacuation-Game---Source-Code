...
#endif
// Native definition for marshalling of: UnityEngine.RaycastHit2D
struct RaycastHit2D_t4063908774_marshaled_pinvoke
{
	Vector2_t2243707579_marshaled_pinvoke ___m_Centroid_0;
	Vector2_t2243707579_marshaled_pinvoke ___m_Point_1;
	Vector2_t2243707579_marshaled_pinvoke ___m_Normal_2;
	float ___m_Distance_3;
	float ___m_Fraction_4;
	Collider2D_t646061738 * ___m_Collider_5;
};
...
{
	Vector2_t2243707579_marshaled_com ___m_Centroid_0;
	Vector2_t2243707579_marshaled_com ___m_Point_1;
	Vector2_t2243707579_marshaled_com ___m_Normal_2;
	float ___m_Distance_3;
	float ___m_Fraction_4;
	Collider2D_t646061738 * ___m_Collider_5;
};
