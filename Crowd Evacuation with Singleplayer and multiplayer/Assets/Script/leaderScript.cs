...
public class leaderScript : MonoBehaviour {
	...
	IEnumerator Start () {
        ...
        for (int i = 1; i <= 5; i++)
        {
            ...
            {
            url = "http://spanky.rutgers.edu/crowdevacgame/experimental/store_data.php?scene=Level" + i.ToString() + "SinglePlayer" + "&loa=" + datapassing.loa + "&homo=" + datapassing.homo + "&type=sp" + "&los=" + datapassing.los;
            }
            else
            {
            url = "http://spanky.rutgers.edu/crowdevacgame/Real/store_data.php?scene=Level" + i.ToString() + "SinglePlayer" + "&loa=" + datapassing.loa + "&homo=" + datapassing.homo + "&type=sp" + "&los=" + datapassing.los;
            }
#endif
            else
#if UNITY_EDITOR
            ...
            if(InternetConnectivityCheck.adminFlag)
            {
            url = "http://spanky.rutgers.edu/crowdevacgame/experimental/store_data.php?scene=Level" + i.ToString() + "&loa=" + datapassing.loa + "&homo=" + datapassing.homo + "&type=mp" + "&los=" + datapassing.los; 
            }
            else
            {
            url = "http://spanky.rutgers.edu/crowdevacgame/Real/store_data.php?scene=Level" + i.ToString() + "&loa=" + datapassing.loa + "&homo=" + datapassing.homo + "&type=mp" + "&los=" + datapassing.los; 
            }
