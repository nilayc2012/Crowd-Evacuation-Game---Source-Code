...
public:
	inline DispatcherKey_t708950850 * GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline DispatcherKey_t708950850 ** GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
...
public:
	inline Dispatcher_t2240407071 * GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline Dispatcher_t2240407071 ** GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
