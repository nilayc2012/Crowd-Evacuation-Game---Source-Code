...
struct UICharInfo_t3056636800_marshaled_pinvoke
{
	Vector2_t2243707579_marshaled_pinvoke ___cursorPos_0;
	float ___charWidth_1;
};
// Native definition for marshalling of: UnityEngine.UICharInfo
struct UICharInfo_t3056636800_marshaled_com
{
	Vector2_t2243707579_marshaled_com ___cursorPos_0;
	float ___charWidth_1;
};
