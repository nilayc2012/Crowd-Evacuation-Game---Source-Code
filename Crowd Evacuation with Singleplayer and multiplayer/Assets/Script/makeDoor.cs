                    ...
                    if (temp.tag == "door")
                {
                    ...
                    if (childtemp.rotation.y == 0)
                    {
                        ...
                        if (downWall != null&&upWall!=null)
                        {
                            ...
                            if (upWall.GetComponent<NewWallScript>() != null)
                            {
                                Destroy(upWall.GetComponent<dooronwall>());
                                upWall.GetComponent<NewWallScript>().enabled = true;
                            }
                       ...
                       else if(upWall==null && downWall!=null)
                        {
                            ...
                            if (downWall.GetComponent<NewWallScript>() != null)
                            {
                                Destroy(downWall.GetComponent<dooronwall>());
                                downWall.GetComponent<NewWallScript>().enabled = true;
                            }
                            Destroy(childtemp.gameObject);
                            Destroy(temp.gameObject);
                        }
                    ...
                    else
                    {
                        ...
                        if (leftWall != null && rightWall != null)
                        {
                            ...
                            if (leftWall.GetComponent<NewWallScript>() != null)
                            {
                                Destroy(leftWall.GetComponent<dooronwall>());
                                leftWall.GetComponent<NewWallScript>().enabled = true;
                            }
                            Destroy(childtemp.gameObject);
                            Destroy(temp.gameObject);
                            Destroy(rightWall);
                        ...
                        else if(leftWall == null && rightWall != null)
                        {
                            ...
                            if (rightWall.GetComponent<NewWallScript>() != null)
                            {
                                Destroy(rightWall.GetComponent<dooronwall>());
                                rightWall.GetComponent<NewWallScript>().enabled = true;
                            }
                            Destroy(childtemp.gameObject);
                            Destroy(temp.gameObject);
                        }
                        else if(leftWall != null && rightWall == null)
                        {
                            ...
                            if (leftWall.GetComponent<NewWallScript>() != null)
                            {
                                Destroy(leftWall.gameObject.GetComponent<dooronwall>());
                                leftWall.GetComponent<NewWallScript>().enabled = true;
                            }
                            Destroy(childtemp.gameObject);
                            Destroy(temp.gameObject);
                            ...
                            if (temp.rotation.y == 0)
                            {
                                ...
                                if (Math.Abs(hitInfo.point.x - xminUp) > WidthOfDoor / 2 && Math.Abs(xmaxDown - hitInfo.point.x) > WidthOfDoor / 2)
                                {
                                   ...
                                   if (temp.GetComponent<NewWallScript>() != null)
                                    {
                                        temp.GetComponent<NewWallScript>().enabled = false;
                                        temp.gameObject.AddComponent<dooronwall>();
